...
pub(crate) const SERVER_NAME_PDDBDISK: &str = "_PDDB Disk_";
    ...
    fn new(xns: &xous_names::XousNames, sid: xous::SID) -> Self {
        ...
        let gam_token = gam
            .register_ux(gam::UxRegistration {
                app_name: xous_ipc::String::<128>::from_str(gam::APP_NAME_PDDBDISK),
...
fn main() -> ! {
    ...
    let sid = xns
        .register_name(SERVER_NAME_PDDBDISK, None)
